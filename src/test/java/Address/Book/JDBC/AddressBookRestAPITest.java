...
public class AddressBookRestAPITest {
	...
	public void givenNewContact_WhenAdded_ShouldReturn201ResponseAndCount() {
		...
		addBookData = new AddressBookData("Sreyansh", "Sharma", "NJP", "Siliguri", "West Bengal", "700087", "9875987534", "sreyansh@gmail.com");
	...
	public void givenCity_WhenUpdated_ShouldReturn200Response() {
		...
		AddressBookData addBookData = addBookService.getContactsData("Sreyansh");
